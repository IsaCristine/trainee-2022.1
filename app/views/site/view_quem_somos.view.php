    ...
    <div class="page-content">
        ...
        <div class="quem_somos">
            ...
            <p>As histórias em quadrinhos nacionais, passados mais de cem anos desde os
                ...
                quadrinhizada no Brasil.</p>
        </div>

        <div class="foto_exemplo">
            <hr>
            <div class="text-center ">
                <img src="../../../public/img/imagem_exemplo.jpg" class="rounded img-fluid"
                    alt="Foto Super Man voando com fundo amarelo">
            </div>
            <hr>
        </div>

        <div class="container conteiner-1">
